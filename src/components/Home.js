        ...
        <div style={{ flex: '1 0 100%' }}>
          ...
          >
            <div style={{ paddingTop: 128, paddingBottom: 128 }}>
              <img
                src="http://ozar6ogjb.bkt.clouddn.com/xzhlogo.png"
                style={{ width: '100%', margin: '20px 0', height: '40vw', maxHeight: '230px' }}
                alt="logo"
              />
                ...
                <div style={{ maxWidth: '50%', flexBasis: '50%' }}>
                  <ul style={{ listStyle: 'none' }}>
                    ...
                    <li style={{ paddingTop: '4px', paddingBottom: '4px', display: 'list-item' }}>
                      <a
                        style={{ color: 'inherit', textDecoration: 'none' }}
                        href="https://www.zhihu.com/people/xu-zi-hao-60/activities"
                      >
                        Zhi Hu
                      </a>
                    </li>
